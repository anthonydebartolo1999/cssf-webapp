...
values
  ('stand-afterlife', 'S01', 'Afterlife Cocktail', 'cocktail', 'Area drink', 'Cocktail Zone - dove potrai gustare tutti i grandi classici della mixology preparati al momento, CAFFE'' AIELLO', '#38bdf8', 'open', 52.3, 16.1, null),
  ...
  ('stand-chimi', 'S06', 'CHIMI', 'carne', 'Area brace', 'Piatto Carne Argentina ASADO, Panini con Hamburger di carne argentina', '#facc15', 'open', 64.4, 67.8, null),
  ('stand-gamro', 'S07', 'GamRo', 'pesce', 'Area mare', 'Frittura cuoppo di calamari - #GlutenFree., Panino polpami (polipo), Panino squiddi (calamari), Panino Crusco (baccala)', '#9333ea', 'open', 25.3, 16.8, null),
  ...
  ('stand-la-verace', 'S09', 'La Verace', 'fritti', 'Area novita', 'Cuzzitiello, Corn Dog, patatine fritte', '#2563eb', 'open', 34.4, 38.7, null),
  ('stand-panzerotto-on-the-road', 'S10', 'Panzerotto on the road', 'fritti', 'Via centrale', 'Panzerotti Caldi (Classico o Silano), Panzerotti Freddi (Primavera o Bolognese), Burrate fritte (Burrata Crudo o Burrata Mortadella)', '#2563eb', 'open', 8.8, 16.7, null),
  ('stand-sams-food-truck', 'S11', 'Sam''s Food Truck', 'bbq', 'Area BBQ', 'Panino con Pulled Pork, Panino con Brisket', '#facc15', 'open', 49.4, 53.4, null),
  ('stand-the-butchers', 'S12', 'The butchers', 'carne', 'Area brace', 'Cipollotto (panino con hamburgher di scottona), Salsicciotto (panino con hamburgher di salsiccia), Porchetto ( panino con porchetta), Cuoppo The Butchers (misto carne), Cuoppo Ribs - {ESCLUSIVA CSSF26}, Cuoppo Alette di Pollo #LimitedEdition', '#facc15', 'open', 37.4, 20.1, null),
